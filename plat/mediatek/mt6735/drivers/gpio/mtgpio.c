...
int32_t gpio_get_pullen_iocfg(uint32_t pin)
{
	switch (pin) {
	case 0 ... 4:
		return IOCFG_1_BASE + 0x030;
	case 5 ... 12:
		return IOCFG_2_BASE + 0x030;
	case 13 ... 21:
		return IOCFG_0_BASE + 0x030;
	case 42 ... 44:
		return IOCFG_1_BASE + 0x030;
	case 47 ... 64:
		return IOCFG_1_BASE + 0x030;
	...
	case 87 ... 88:
		return IOCFG_2_BASE + 0x030;
	case 89 ... 114:
		return IOCFG_2_BASE + 0x040;
	case 118 ... 149:
		return IOCFG_3_BASE + 0x030;
	case 184 ... 190:
		return IOCFG_5_BASE + 0x030;
	default:
		return -1;
	}
}

int32_t gpio_get_pullsel_iocfg(uint32_t pin)
{
	switch (pin) {
	case 0 ... 4:
		return IOCFG_1_BASE + 0x050;
	case 5 ... 12:
		return IOCFG_2_BASE + 0x050;
	case 13 ... 21:
		return IOCFG_0_BASE + 0x050;
	case 42 ... 44:
		return IOCFG_1_BASE + 0x050;
	case 47 ... 64:
		return IOCFG_1_BASE + 0x050;
	...
	case 87 ... 88:
		return IOCFG_2_BASE + 0x050;
	case 89 ... 114:
		return IOCFG_2_BASE + 0x060;
	case 118 ... 149:
		return IOCFG_3_BASE + 0x050;
	case 184 ... 190:
		return IOCFG_5_BASE + 0x050;
	default:
		return -1;
	}
}
int32_t gpio_get_pupd_iocfg(uint32_t pin)
{
	...
	switch (pin) {
	case 45 ... 46:
		return IOCFG_1_BASE + 0x080;
	case 81 ... 86:
		return IOCFG_2_BASE + 0x080;
	case 160 ... 165:
		return IOCFG_3_BASE + 0x090;
	case 166 ... 171:
		return IOCFG_3_BASE + 0x080;
	case 172 ... 179:
		return IOCFG_4_BASE + 0x080;
	case 180 ... 183:
		return IOCFG_4_BASE + 0x090;
	case 198 ... 203:
		return IOCFG_0_BASE + 0x080;
	default:
		return -1;
	}
}
...
{
	int pullen_addr = gpio_get_pullen_iocfg(pin);
...
{
	int pullsel_addr = gpio_get_pullsel_iocfg(pin);
	int pupd_addr = gpio_get_pupd_iocfg(pin);
	int pupd_offset = gpio_get_pupd_offset(pin);
