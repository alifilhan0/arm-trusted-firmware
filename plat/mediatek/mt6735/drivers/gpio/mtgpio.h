...
typedef struct {
	VAL_REGS dir[7];        /*0x0000 ~ 0x006F:  96 bytes */
	uint8_t rsv00[160];     /*0x0070 ~ 0x00FF: 160 bytes */
	VAL_REGS dout[7];       /*0x0100 ~ 0x016F:  96 bytes */
	uint8_t rsv01[160];     /*0x0170 ~ 0x01FF: 160 bytes */
	VAL_REGS din[7];        /*0x0200 ~ 0x026F:  96 bytes */
	uint8_t rsv02[160];     /*0x0270 ~ 0x02FF: 160 bytes */
	VAL_REGS mode[20];      /*0x0300 ~ 0x043F: 368 bytes */
} GPIO_REGS;
