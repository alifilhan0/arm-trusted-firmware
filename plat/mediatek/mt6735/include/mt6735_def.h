...
#if RESET_TO_BL31
#error "MT6735 is incompatible with RESET_TO_BL31!"
#endif

#define MT6735_PRIMARY_CPU	0x0

/* Register base address */
#define IO_PHYS			(0x10000000)
#define INFRACFG_AO_BASE	(IO_PHYS + 0x0000)
#define SRAMROM_SEC_BASE	(IO_PHYS + 0x202000)
#define PERI_CON_BASE		(IO_PHYS + 0x2000)
#define GPIO_BASE		(IO_PHYS + 0x211000)
#define IOCFG_0_BASE 		(GPIO_BASE+0x800)
#define IOCFG_1_BASE 		(GPIO_BASE+0x900)
#define IOCFG_2_BASE 		(GPIO_BASE+0xA00)
#define IOCFG_3_BASE 		(GPIO_BASE+0xB00)
#define IOCFG_4_BASE 		(GPIO_BASE+0xC00)
#define IOCFG_5_BASE 		(GPIO_BASE+0xD00)
#define SPM_BASE		(IO_PHYS + 0x6000)
#define RGU_BASE		(IO_PHYS + 0x212000)
#define PMIC_WRAP_BASE		(IO_PHYS + 0x1000)
#define DEVAPC0_BASE		(IO_PHYS + 0x207000)
 ...
 ******************************************************************************/
#define MT6735_UART0_BASE	(IO_PHYS + 0x01002000)
#define MT6735_UART1_BASE	(IO_PHYS + 0x01003000)
#define MT6735_UART2_BASE	(IO_PHYS + 0x01004000)
#define MT6735_UART3_BASE	(IO_PHYS + 0x01005000)

#define MT6735_BAUDRATE		(115200)
#define MT6735_UART_CLOCK	(26000000)
